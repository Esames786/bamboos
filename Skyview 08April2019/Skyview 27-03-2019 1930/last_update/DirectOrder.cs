...
namespace Skyview
{
    public partial class DirectOrder : Form
    {
        ...
        private void total()
        {
            ...
            {
                decimal my_dis = 0;
                decimal strn = Convert.ToDecimal(txt_strn.Text);
                decimal temp = 0;
                ...
                {
                    total += Convert.ToDecimal(grid.Rows[b].Cells[3].Value);
                    discount += Convert.ToDecimal(grid.Rows[b].Cells[4].Value);
                }
                strn = (total * strn) / 100;
                total = total + strn;
        ...
        public void Print()
        {
            ...
            if (dv.Rows.Count > 0)
            {
                receipt3 rt = new receipt3(); rt.SetDataSource(dv); viewer_of_table_close aop = new viewer_of_table_close(rt, txt_rec, txt_return, 0,service_c,Convert.ToDecimal(txt_strn.Text)); aop.Show();
                rt.PrintToPrinter(1, false, 0, 0);
            }
