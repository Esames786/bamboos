...
namespace Skyview
{
    public partial class Receipt_voucher : Form
    {
        ...
        {
            InitializeComponent();
            clsGeneral.SetAutoCompleteTextBox(txtparty, clsDataLayer.RetreiveQuery("select ActTitle from Accounts where ID > 14 and Status = 1  and [HeaderActCode] != '20101' Order BY ID DESC"));
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                clsGeneral.SetAutoCompleteTextBox(txtparty, clsDataLayer.RetreiveQuery("select ActTitle from Accounts where ID > 14 and [HeaderActCode] != '20101' Order BY ID DESC"));
                txtbname.Enabled = false; txtbano.Enabled = false; txtcheque.Enabled = false;
                txtbname.Text = "-"; txtbano.Text = "-"; txtcheque.Text = "-"; //button1.Enabled = true;
            }
            catch { }
        ...
        private void ReceiveDue()
        {
            ...
            if (req == true)
            {
                ...
                values('" + txtInvoice.Text + "','" + txtparty.Text + "','" + Code + "'," + txtCashRelease.Text + "," + txtCashRelease.Text + ",0,'" + txt_company.Text + "')";
        ...
        private void btnedit_Click(object sender, EventArgs e)
        {
            ...
            txtparty.Enabled = false; //button1.Enabled = false;
